...
class GoodHabitsListFragment : Fragment() {
    ...
    private var binding: FragmentGoodHabitsListBinding? = null
    private lateinit var habitsAdapter: HabitsAdapter

    private val habitsListener: HabitsListener = { it ->
        habitsAdapter.habits = it.filter { it.habitType == HabitType.GOOD }
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentGoodHabitsListBinding.inflate(inflater)
        return binding!!.root
    }
